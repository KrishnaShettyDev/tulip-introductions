const FooterSection = () => {
  return (
    <footer className="py-12 sm:py-16 px-4 sm:px-6 border-t border-ink-border bg-[hsl(var(--background))]">
      <div className="max-w-5xl mx-auto">
        {/* Logo */}
        <div className="mb-6 sm:mb-8">
          <a href="#" className="font-serif text-xl sm:text-2xl text-ink">
            🌷 tulip
          </a>
        </div>
        ...
        <div className="mb-6 sm:mb-8">
          <a
            href="mailto:founders@heytulip.in"
            className="text-ink/70 font-sans text-sm hover:text-ink transition-colors"
          >
            founders@heytulip.in
          </a>
        </div>
